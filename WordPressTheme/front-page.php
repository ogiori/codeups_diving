 ...
 <div class="inner about__inner">
  ...
  <div class="about__wrap">
   ...
   <div class="about__container">
    ...
    <?php $page_company = get_page_by_path('about');
    $about_text = get_field('about_text', $page_company->ID); ?>
 ...
 <div class="inner price__inner">
  ...
  <div class="price__wrap">
   <figure class="price__img js-trigger">
    <picture>
     <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/common/price_img-pc.jpg" media="(min-width: 768px)" alt="亀と魚の群れの写真">
