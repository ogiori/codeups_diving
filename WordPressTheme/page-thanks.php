...
<section class="page-thanks-space page-thanks">
  <div class="page-thanks__inner inner inner-icon">

    <h2 class="page-thanks__title">お問い合わせ内容を送信完了しました。</h2>
    <p class="page-thanks__text">このたびは、お問い合わせ頂き<br class="u-mobile">誠にありがとうございます。<br>
