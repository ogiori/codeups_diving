...
const idExperience = document.getElementById("experience");
const idFun = document.getElementById("fun");
const idLicense = document.getElementById("license");
...
accordionsArr.forEach((accordion) => {
  ...
  // 最初のアコーディオン要素にクラスを追加
  const firstAccordionContent = accordion.querySelector(".js-accordion-contents");
  if (firstAccordionContent) {
    firstAccordionContent.classList.add("is-open");
  }

  // 最初のトリガー要素にクラスを追加
  const firstAccordionTrigger = accordion.querySelector(".js-accordion-trigger");
    ...
    trigger.addEventListener("click", (e) => {
      accordionTriggersArr.forEach((trigger) => {
        ...
        if (trigger !== e.target.parentElement) {
          ...
          const openedContent = trigger.querySelector(".js-accordion-contents");
      ...
      // 開閉させる要素を取得
      const content = trigger.querySelector(".js-accordion-contents");
      // 要素を展開or閉じる
      slideToggle(content);
    });
  });
...
faqAccordionsArr.forEach((accordion) => {
  ...
  accordionTriggersArr.forEach((trigger) => {
    ...
    trigger.addEventListener("click", () => {
      ...
      // 開閉させる要素を取得
      const content = trigger.querySelector(".js-faq-accordion-contents");
      // 要素を展開or閉じる
      slideToggle(content);
    });
  });
